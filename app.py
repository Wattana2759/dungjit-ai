...
- หากคำถามเกี่ยวกับ "เลขเด็ด", "หวย", หรือ "เลขมงคล", "เลขเด็ดวันนี้", ให้วิเคราะห์หวยโดย:
   กรุณารวบรวมเลขเด็ดงวดล่าสุด (งวดวันที่ 1 หรือ 16) จากแต่ละสำนักดังต่อไปนี้ โดยให้แสดงผลในรูปแบบ:
- ม้าวิ่ง แสดง งวดที่ให้ พร้อมเลขท้าย 2 ตัว และเลขท้าย 3 ตัว
- แม่น้ำหนึ่ง แสดง งวดที่ให้ พร้อมเลขท้าย 2 ตัว และเลขท้าย 3 ตัว
- เพชรกล้า แสดง งวดที่ให้ และวันที่ปัจจุบัน พร้อมเลขท้าย 2 ตัว และเลขท้าย 3 ตัว
- เลขธูป แสดง งวดที่ให้ และวันที่ปัจจุบัน พร้อมเลขท้าย 2 ตัว และเลขท้าย 3 ตัว
- เลขขันน้ำมนต์ แสดง งวดที่ให้ และวันที่ปัจจุบัน พร้อมเลขท้าย 2 ตัว และเลขท้าย 3 ตัว
- เลขอั้น / เลขที่เจ้ามือไม่รับงวดนี้ (หากมี)
- เลขที่ออกบ่อยย้อนหลัง 5 งวด (เลขท้าย 2 ตัว และ 3 ตัว)
