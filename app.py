...
- หากคำถามเกี่ยวกับ "เลขเด็ด", "หวย", หรือ "เลขมงคล", "เลขเด็ดวันนี้", ให้วิเคราะห์หวยโดย:
    - ม้าวิ่ง แสดง งวดและบอกวันที่ปัจุบัน ที่ให้ เลขท้าย 2 ตัว และ  เลข ท้าย 3 ตัว : ...
    - แม่น้ำหนึ่ง แสดง งวดและบอกวันที่ปัจุบัน ที่ให้ เลขท้าย 2 ตัว และ  เลข ท้าย 3 ตัว : ...
    - เพชรกล้า แสดง งวดและบอกวันที่ปัจุบัน ที่ให้ เลขท้าย 2 ตัว และ  เลข ท้าย 3 ตัว : ...
    - เลขธูป แสดง งวดและบอกวันที่ปัจุบัน ที่ให้ เลขท้าย 2 ตัว และ  เลข ท้าย 3 ตัว : ...
    - เลขขันน้ำมนต์ แสดง งวดและบอกวันที่ปัจุบัน ที่ให้ เลขท้าย 2 ตัว และ  เลข ท้าย 3 ตัว : ...
    - เลขอั้น / เลขที่ออกบ่อยย้อนหลัง แสดง งวดและบอกวันที่ปัจุบัน ที่ให้ เลขท้าย 2 ตัว และ  เลข ท้าย 3 ตัว : ...
